...
class DiscretionaryLLMEngine:
    ...
    def _responses_create_with_retry(self, *, phase: str, timeout_seconds: Optional[float] = None, **create_kwargs) -> Any:
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            try:
                response = self.client.responses.create(timeout=timeout_seconds, **create_kwargs)
    ...
    def _call_passive_two_step_model(
        ...
        *,
        ...
        if (
            ...
            judge_output = dict(prefetched.get("judge_output") or {})
            judge_debug = {
            ...
            judge_output, judge_debug = self._call_passive_event_judge(
                phase=phase,
                trigger_event=trigger_event,
                recent_events=recent_events,
                market_mainline_context=market_mainline_context,
        ...
        pricing_output: Dict[str, float] = {"entry_price": 0.0, "stop_loss_price": 0.0}
        pricing_debug: Dict[str, Any] = {}
        if should_price:
            pricing_output, pricing_debug = self._call_passive_technical_pricing(
                phase=phase,
                action=action,
                chart_input_context=chart_input_context,
                reasoning_effort=reasoning_effort,
