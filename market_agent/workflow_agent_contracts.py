...
class AgentInvocation(StrictModel):
    ...
    # Direct callers predate the per-attempt policy.  This finite ceiling is
    # deliberately longer than their existing bounded workflow deadlines.
    attempt_timeout_seconds: PositiveFinite = 86_400.0
