...
class ReleaseGate:
    ...
    def evaluate(self, candidate, baseline=None) -> ReleaseDecision:
        ...
        reasons = []
        if candidate.execution_mode != "executed":
            reasons.append("executed_mode_required")
        elif not candidate.binding_verified:
            reasons.append("execution_binding_unverified")
        ...
        elif (candidate.dataset_hash != baseline.dataset_hash or candidate.evaluator_version != baseline.evaluator_version
              or candidate.answer_schema_hash != baseline.answer_schema_hash or candidate.execution_mode != baseline.execution_mode):
