...
class RecordedOutcome(ContractModel):
    """Durable, host-authenticated input to deterministic candidate extraction."""
...
class MemoryResultWriter:
    ...
    def record(
        ...
        return RecordedOutcome(event=event, decision=decision, outcome=outcome)
